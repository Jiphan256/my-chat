...
},{}],"lMcE":[function(require,module,exports) {
"use strict";
 ...
 * @public
 */
},{"./url.js":"w3Sn","./manager.js":"s1gw","./socket.js":"KTgC","socket.io-parser":"mSEf"}],"lY9v":[function(require,module,exports) {
"use strict";
...
function App() {
  ...
  var messagesEnd = (0, _react.useRef)();
  (0, _react.useEffect)(function () {
    socketRef.current = _socket.default.connect(host);
    socketRef.current.on('getId', function (data) {
      setId(data);
    });
    socketRef.current.on('sendDataServer', function (dataGot) {
      setMess(function (oldMsgs) {
        return [].concat(_toConsumableArray(oldMsgs), [dataGot.data]);
      });
      scrollToBottom();
    });
    return function () {
  ...
  var renderMess = mess.map(function (m, index) {
    return /*#__PURE__*/_react.default.createElement("div", {
      key: index,
      className: "".concat(m.id === id ? 'your-message' : 'other-people', " chat-item")
    }, m.content);
  });
  ...
  }, renderMess, /*#__PURE__*/_react.default.createElement("div", {
    style: {
      float: "left",
      clear: "both"
    },
...
var _default = App;
exports.default = _default;
},{"react":"n8MK","socket.io-client":"DNkq","./App.css":"vKFU"}],"FheM":[function(require,module,exports) {
var bundleURL = null;
...
exports.default = _default;
},{"_bundle_loader":"TUK3","web-vitals":[["web-vitals.967f753d.js","f6pS"],"web-vitals.967f753d.js.map","f6pS"]}],"Focm":[function(require,module,exports) {
"use strict";
...
_reactDom.default.render( /*#__PURE__*/_react.default.createElement(_react.default.StrictMode, null, /*#__PURE__*/_react.default.createElement(_App.default, null)), document.getElementById('chat-box')); // If you want to start measuring performance in your app, pass a function
